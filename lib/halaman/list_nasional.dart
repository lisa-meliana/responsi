...
class ListNasional extends StatelessWidget {
  const ListNasional({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("List Nasional"),
      ),
      body: _buildListNasionalsBody(),
    );
  }

  // bentuk data api Future, jadi pake FutureBuilder
  // karna isinya belum tentu ada
  Widget _buildListNasionalsBody(){
    return Container(
      child: FutureBuilder(
